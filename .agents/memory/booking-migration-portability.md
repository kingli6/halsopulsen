...
Booking schema migrations must handle equivalent constraints whose names differ between development PostgreSQL and the Supabase foundation. Once a filename has been recorded as applied, use a new corrective migration rather than editing its historical behavior in place.
